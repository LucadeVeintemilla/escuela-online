<div class="card card-default">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h3 class="card-title">Gestionar Anuncios</h3>
    <div>
      <span class="badge badge-info">Crear y publicar anuncios a Docentes y/o Alumnos</span>
    </div>
  </div>
  <div class="card-body">
    @if ($mensaje)
    ...
    <form wire:submit.prevent="guardar">
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <select class="form-control @error('destinatario') is-invalid @enderror" wire:model="destinatario">
