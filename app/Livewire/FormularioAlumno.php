...
class FormularioAlumno extends Component
{
    ...
    protected function reglas(?int $id = null): array
    {
        return [
            ...
            'dni'        => [
                'required',
                'digits:8',
                Rule::unique('alumnos', 'dni')->ignore($id)->whereNull('deleted_at'),
            ],
    ...
    public function actualizar()
    {
        ...
        $modeloString = 'App\\Models\\' . ($this->modelo ?? 'Alumno');
        ...
        if ($saved) {
            ...
            $this->js("window.dispatchEvent(new CustomEvent('close-modal-alumno'))");
        }
    }
