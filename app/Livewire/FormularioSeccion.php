...
class FormularioSeccion extends Component
{
    public $modelo;
    public $id;
    ...
    public function actualizar()
    {
        ...
        $modeloString = 'App\\Models\\' . ($this->modelo ?? 'Seccion');
    ...
    {
        return view('livewire.formulario-seccion');
    }
}