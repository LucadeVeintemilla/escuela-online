...
return [
    ...
    | como las reglas de tamaño. Puedes modificarlas libremente aquí.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado ha aparecido en una filtración de datos. Por favor, elige otro diferente.',
    ],
    ...
    | utilizando la convención "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para reemplazar el marcador de posición
    | de atributo por algo más amigable como "Correo electrónico" en lugar de "email".
    |
    */
